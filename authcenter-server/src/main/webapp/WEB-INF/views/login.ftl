...
<body class="login-layout" style="background: url('/static/img/bg.jpg') no-repeat">
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border" style="background-color: transparent">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form id="fm" action="/sso/login" method="post">
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    <label class="inline">
                                                    <input type="checkbox" class="ace" name="rememberMe" id="rememberMe" value="1"/>
    ...
    <script type="text/javascript" src="${request.contextPath}/static/js/sha1.js"></script>
